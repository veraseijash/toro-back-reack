...
export class ParasiticformsController {
  ...
  @UseGuards(JwtUserGuard)
  @Delete(':id')
  deleteParasiticforms(@Param('id', ParseIntPipe) id: number) {
    return this.parasiticformsService.deleteParasiticforms(id);
  }
  ...
  @UseGuards(JwtUserGuard)
  @Patch(':id')
  updateParasiticforms(
    @Param('id', ParseIntPipe) id: number,
    @Body() parasitic: UpdateparasiticformsDto,
  ) {
